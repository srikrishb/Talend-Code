...
package mysql_elasticsearch.step_genericloadelasticsearch_0_1;
...
/**
 * Job: step_genericloadElasticsearch Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class step_genericloadElasticsearch implements TalendJob {
...
public String getURL(){
	...
	private final String jobName = "step_genericloadElasticsearch";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				step_genericloadElasticsearch.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(step_genericloadElasticsearch.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch = new byte[0];
    static byte[] commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch.length) {
				if(length < 1024 && commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch.length == 0) {
   					commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch = new byte[1024];
				} else {
   					commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch, 0, length);
			strReturn = new String(commonByteArray_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MYSQL_ELASTICSEARCH_step_genericloadElasticsearch) {
 ...
 */
    ...
    public static void main(String[] args){
        final step_genericloadElasticsearch step_genericloadElasticsearchClass = new step_genericloadElasticsearch();

        int exitCode = step_genericloadElasticsearchClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = step_genericloadElasticsearch.class.getClassLoader().getResourceAsStream("mysql_elasticsearch/step_genericloadelasticsearch_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : step_genericloadElasticsearch");
        }
...
/************************************************************************************************
 *     76177 characters generated by Talend Open Studio for Big Data 
 *     on the January 16, 2018 1:24:22 AM EST
 ************************************************************************************************/