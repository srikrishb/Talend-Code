...
package ruleengine_elasticsearch.step_extractdatanormalizedout_0_1;
...
/**
 * Job: step_extractDataNormalizedOut Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class step_extractDataNormalizedOut implements TalendJob {
	...
	private final String jobName = "step_extractDataNormalizedOut";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					step_extractDataNormalizedOut.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(step_extractDataNormalizedOut.this,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut = new byte[0];
		static byte[] commonByteArray_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut.length) {
					if (length < 1024
							&& commonByteArray_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut.length == 0) {
						commonByteArray_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut = new byte[1024];
					} else {
						commonByteArray_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RULEENGINE_ELASTICSEARCH_step_extractDataNormalizedOut) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.io.File file_tFileOutputJSON_1 = new java.io.File(
						"K:/TOS_BD-20170623_1246-V6.4.1/workspace/out.json");
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "K:/TOS_BD-20170623_1246-V6.4.1/workspace/out.csv";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"K:/TOS_BD-20170623_1246-V6.4.1/workspace/out.csv",
								"ISO-8859-15", ";", "\n", true, 0, 0, -1, -1,
								false);
					...
					while (fid_tFileInputDelimited_3 != null
						...
						try {
							...
							row2.ruleid = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 1;

							row2.rule_execution_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							row2.email = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
						...
						if (row2 != null) {
							...
							if (row2.ruleid != null) {
								...
								jsonRowtFileOutputJSON_1.put("ruleid",
										row2.ruleid);
							...
							if (row2.salary != null) {
								...
								jsonRowtFileOutputJSON_1.put("salary",
										row2.salary);
							...
							if (row2.gross_sal != null) {
								...
								jsonRowtFileOutputJSON_1.put("gross_sal",
										row2.gross_sal);
							...
							if (row2.email != null) {
								...
								jsonRowtFileOutputJSON_1.put("email",
										row2.email);
					...
					if (!((Object) ("K:/TOS_BD-20170623_1246-V6.4.1/workspace/out.csv") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final step_extractDataNormalizedOut step_extractDataNormalizedOutClass = new step_extractDataNormalizedOut();

		int exitCode = step_extractDataNormalizedOutClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = step_extractDataNormalizedOut.class
					.getClassLoader().getResourceAsStream(
							"ruleengine_elasticsearch/step_extractdatanormalizedout_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : step_extractDataNormalizedOut");
		}
...
/************************************************************************************************
 * 74694 characters generated by Talend Open Studio for Big Data on the January
 * 16, 2018 1:58:37 AM EST
 ************************************************************************************************/
