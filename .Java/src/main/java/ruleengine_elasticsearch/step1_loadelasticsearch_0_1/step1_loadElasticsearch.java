...
public class step1_loadElasticsearch implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(step1_loadElasticsearch.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RULEENGINE_ELASTICSEARCH_step1_loadElasticsearch.length) {
					if (length < 1024
							&& commonByteArray_RULEENGINE_ELASTICSEARCH_step1_loadElasticsearch.length == 0) {
				...
				dis.readFully(
						commonByteArray_RULEENGINE_ELASTICSEARCH_step1_loadElasticsearch,
						0, length);
					...
					while (limittFileInputDelimited_1 != 0
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]
										...
										try {
											...
											row2.rule_execution_id = ParserUtils
													.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row2.result = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if (row2 != null) {
							...
							if (row2.result != null) {
								...
								jsonRowtFileOutputJSON_1.put("result",
										row2.result);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = step1_loadElasticsearch.class
					.getClassLoader().getResourceAsStream(
							"ruleengine_elasticsearch/step1_loadelasticsearch_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : step1_loadElasticsearch");
		}
...
/************************************************************************************************
 * 48324 characters generated by Talend Open Studio for Big Data on the January
 * 16, 2018 2:06:43 AM EST
 ************************************************************************************************/
