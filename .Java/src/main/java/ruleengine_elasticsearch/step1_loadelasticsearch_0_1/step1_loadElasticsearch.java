...
package ruleengine_elasticsearch.step1_loadelasticsearch_0_1;
...
/**
 * Job: step1_loadElasticsearch Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class step1_loadElasticsearch implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(outputJSONFileName != null){
					...
					this.setProperty("outputJSONFileName", outputJSONFileName.toString());
...
public String getOutputJSONFileName(){
	return this.outputJSONFileName;
}
...
public String getIndexType(){
	...
	private final String jobName = "step1_loadElasticsearch";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				step1_loadElasticsearch.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(step1_loadElasticsearch.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.File file_tFileOutputJSON_1 = new java.io.File(context.outputJSONFileName);
...
java.io.PrintWriter outtFileOutputJSON_1 = new java.io.PrintWriter(new java.io.BufferedWriter(new java.io.FileWriter(context.outputJSONFileName)));
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = context.inputFileName;
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.inputFileName, "ISO-8859-15",";","\n",true,1,0,-1,-1, false);
				...
				int columnIndexWithD_tFileInputDelimited_2 = 0;
					...
					columnIndexWithD_tFileInputDelimited_2 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.ruleid = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.rule_execution_id = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_2 = 3;
							...
							row2.result = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.salary = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_2 = 5;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.tax = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_2 = 6;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.gross_sal = ParserUtils.parseTo_Integer(temp);
...
org.json.simple.JSONObject jsonRowtFileOutputJSON_1 = new org.json.simple.JSONObject();
					...
					jsonRowtFileOutputJSON_1.put("ruleid", row2.ruleid);
				
					}else{
						jsonRowtFileOutputJSON_1.put("ruleid", null);
					}
				
			    	if(row2.rule_execution_id != null){
			    
					jsonRowtFileOutputJSON_1.put("rule_execution_id", row2.rule_execution_id);
				
					}else{
						jsonRowtFileOutputJSON_1.put("rule_execution_id", null);
					}
				
			    	if(row2.id != null){
			    
					jsonRowtFileOutputJSON_1.put("id", row2.id);
					...
					jsonRowtFileOutputJSON_1.put("result", row2.result);
				
					}else{
						jsonRowtFileOutputJSON_1.put("result", null);
					}
				
			    	if(row2.salary != null){
			    
					jsonRowtFileOutputJSON_1.put("salary", row2.salary);
				
					}else{
						jsonRowtFileOutputJSON_1.put("salary", null);
					}
				
			    	if(row2.tax != null){
			    
					jsonRowtFileOutputJSON_1.put("tax", row2.tax);
				
					}else{
						jsonRowtFileOutputJSON_1.put("tax", null);
					}
				
			    	if(row2.gross_sal != null){
			    
					jsonRowtFileOutputJSON_1.put("gross_sal", row2.gross_sal);
				
					}else{
						jsonRowtFileOutputJSON_1.put("gross_sal", null);
					}
				
			    	if(row2.email != null){
			    
					jsonRowtFileOutputJSON_1.put("email", row2.email);
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param indexName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param indexName=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		...
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param indexType=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param indexType=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("indexType", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.outputJSONFileName;
		if(obj_tRunJob_1!=null) {
		...
		ruleengine_elasticsearch.step2_genericloadelasticsearch_0_1.step2_genericloadElasticsearch childJob_tRunJob_1 = new ruleengine_elasticsearch.step2_genericloadelasticsearch_0_1.step2_genericloadElasticsearch();
	    // pass DataSources
...
System.out.println(context.inputFileName);
System.out.println(context.outputJSONFileName);
System.out.println(context.indexName);
System.out.println(context.indexType);
 ...
 */
    ...
    public static void main(String[] args){
        final step1_loadElasticsearch step1_loadElasticsearchClass = new step1_loadElasticsearch();

        int exitCode = step1_loadElasticsearchClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = step1_loadElasticsearch.class.getClassLoader().getResourceAsStream("ruleengine_elasticsearch/step1_loadelasticsearch_0_1/contexts/"+contextStr+".properties");
            ...
            if(!context_param.isEmpty()) {
                ...
                context.inputFileName=(String) context.getProperty("inputFileName");
				    context.setContextType("outputJSONFileName", "id_String");
				
                context.outputJSONFileName=(String) context.getProperty("outputJSONFileName");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("inputFileName")) {
                context.inputFileName = (String) parentContextMap.get("inputFileName");
            }if (parentContextMap.containsKey("outputJSONFileName")) {
                context.outputJSONFileName = (String) parentContextMap.get("outputJSONFileName");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : step1_loadElasticsearch");
        }
