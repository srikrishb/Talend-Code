...
public class TImpalaConnectionBeginJava
{
  ...
  protected final String TEXT_124 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_125 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_132 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_135 = ".get(dsAlias_";
  protected final String TEXT_136 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_137 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_138 = " = dataSources_";
  protected final String TEXT_139 = ".get(dsAlias_";
  protected final String TEXT_140 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_141 = "\", conn_";
  protected final String TEXT_142 = ");" + NL + "\t}";
  protected final String TEXT_143 = NL + "\tif (null != conn_";
