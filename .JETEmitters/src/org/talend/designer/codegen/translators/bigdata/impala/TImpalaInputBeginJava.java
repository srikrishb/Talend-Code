...
public class TImpalaInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:hive2://\"+";
  ...
  protected final String TEXT_187 = "\");" + NL + "\t\t\tif(dbname_";
  protected final String TEXT_188 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_189 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_190 = ".trim())) {" + NL + "\t\t\t\tjava.sql.Statement goToDatabase_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_193 = ".execute(\"use \" + dbname_";
  protected final String TEXT_194 = ");" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_195 = ".close();" + NL + "\t\t    }";
  protected final String TEXT_196 = NL + "\t\t\tString dbname_";
  protected final String TEXT_197 = " = ";
  protected final String TEXT_198 = ";" + NL + "\t\t\tif(dbname_";
  protected final String TEXT_199 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_200 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_201 = ".trim())) {" + NL + "\t\t\t\tjava.sql.Statement goToDatabase_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_204 = ".execute(\"use \" + dbname_";
  protected final String TEXT_205 = ");" + NL + "\t\t\t\tgoToDatabase_";
  ...
  protected final String TEXT_209 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_210 = " = null;";
  protected final String TEXT_211 = NL + "\t\t        conn_";
  protected final String TEXT_212 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_213 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_214 = NL + "\t\t\t\t";
  protected final String TEXT_215 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_216 = " =  conn_";
  protected final String TEXT_217 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_218 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_219 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_220 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_221 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_222 = NL + "                 conn_";
  protected final String TEXT_223 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_224 = NL + "               ";
  protected final String TEXT_225 = " + \"=\" + ";
  protected final String TEXT_226 = " + \";\" +";
  protected final String TEXT_227 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_228 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_229 = ");";
  protected final String TEXT_230 = NL + "\t\t    ";
  protected final String TEXT_231 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_232 = " = ";
  protected final String TEXT_233 = ";" + NL + "\t\t\t";
  protected final String TEXT_234 = NL + "                log.debug(\"";
  protected final String TEXT_235 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_242 = "_QUERY\",dbquery_";
  protected final String TEXT_243 = ");";
  protected final String TEXT_244 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_245 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_246 = " = stmt_";
  protected final String TEXT_247 = ".executeQuery(dbquery_";
  protected final String TEXT_248 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_249 = " = rs_";
  protected final String TEXT_250 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_251 = " = rsmd_";
  protected final String TEXT_252 = ".getColumnCount();" + NL;
  protected final String TEXT_253 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_254 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_255 = ".setDbmsId(\"";
  protected final String TEXT_256 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_257 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_258 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_259 = ".add(\"";
  protected final String TEXT_260 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_261 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_262 = " = ";
  protected final String TEXT_263 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_264 = "; i <= rsmd_";
  protected final String TEXT_265 = ".getColumnCount()-";
  protected final String TEXT_266 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_267 = ".contains(rsmd_";
  protected final String TEXT_268 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_269 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_270 = ".setName(rsmd_";
  protected final String TEXT_271 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_272 = ".setDbName(rsmd_";
  protected final String TEXT_273 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_274 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_275 = "\", rsmd_";
  protected final String TEXT_276 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_277 = ".getPrecision(i), rsmd_";
  protected final String TEXT_278 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_279 = ".setDbType(rsmd_";
  protected final String TEXT_280 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setDbTypeId(rsmd_";
  protected final String TEXT_282 = ".getColumnType(i));";
  protected final String TEXT_283 = NL + "                \tdcm_";
  protected final String TEXT_284 = ".setFormat(";
  protected final String TEXT_285 = ");";
  protected final String TEXT_286 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_287 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_288 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_289 = ".setLength(rsmd_";
  protected final String TEXT_290 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_291 = ".setLength(rsmd_";
  protected final String TEXT_292 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_293 = NL + "\t\t\tdcm_";
  protected final String TEXT_294 = ".setLength(rsmd_";
  protected final String TEXT_295 = ".getPrecision(i));";
  protected final String TEXT_296 = NL + "                \tdcm_";
  protected final String TEXT_297 = ".setPrecision(rsmd_";
  protected final String TEXT_298 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setNullable(rsmd_";
  protected final String TEXT_300 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_301 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_304 = ".metadatas.add(dcm_";
  protected final String TEXT_305 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_306 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_307 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_308 = NL + "\t\t    \tint column_index_";
  ...
  protected final String TEXT_343 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_344 = ".getObject(";
  protected final String TEXT_345 = "column_index_";
  protected final String TEXT_346 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_347 = NL + "                                    ";
  protected final String TEXT_348 = ".";
  protected final String TEXT_349 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_366 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_383 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_384 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_385 = ".getColumnTypeName(i_";
  protected final String TEXT_386 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_387 = ".add(rs_";
  protected final String TEXT_388 = ".getString(i_";
  protected final String TEXT_389 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_390 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
