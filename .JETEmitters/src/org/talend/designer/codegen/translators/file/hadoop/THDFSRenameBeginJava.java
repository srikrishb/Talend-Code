...
public class THDFSRenameBeginJava
{
  ...
  protected final String TEXT_135 = " = 0;" + NL + "\t" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  ...
  protected final String TEXT_147 = "\t" + NL + "" + NL + "\tfor (java.util.Map<String, String> map_";
