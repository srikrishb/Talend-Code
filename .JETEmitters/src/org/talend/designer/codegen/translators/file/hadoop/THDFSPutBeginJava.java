...
public class THDFSPutBeginJava
{
  ...
  protected final String TEXT_136 = " = 0;" + NL + "\t" + NL + "\tfs_";
  protected final String TEXT_137 = ".mkdirs(new org.apache.hadoop.fs.Path(";
  protected final String TEXT_138 = "));" + NL + "\tjava.util.List<String> msg_";
  protected final String TEXT_139 = " = new java.util.ArrayList<String>();" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_140 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_141 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_142 = "_";
  protected final String TEXT_143 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_144 = "_";
  protected final String TEXT_145 = ".put(";
  protected final String TEXT_146 = ",";
  protected final String TEXT_147 = ");\t\t" + NL + "\t \tlist_";
  protected final String TEXT_148 = ".add(map_";
  protected final String TEXT_149 = "_";
  protected final String TEXT_150 = ");       " + NL + "\t";
  protected final String TEXT_151 = "\t" + NL + "" + NL + "\tString localdir_";
  protected final String TEXT_152 = "  = ";
  protected final String TEXT_153 = ";\t" + NL + "\tfor (java.util.Map<String, String> map_";
