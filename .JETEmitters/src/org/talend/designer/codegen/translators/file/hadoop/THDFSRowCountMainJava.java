...
public class THDFSRowCountMainJava
{
  ...
  protected final String TEXT_134 = NL + "\t  String filename_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "\t  int emptyLineCount_";
  protected final String TEXT_137 = " = 0;" + NL + "\t  org.apache.hadoop.fs.Path file_";
  protected final String TEXT_138 = " = new org.apache.hadoop.fs.Path(filename_";
  protected final String TEXT_139 = ");" + NL + "\t  org.apache.hadoop.fs.FSDataInputStream fsdis_";
  protected final String TEXT_140 = " = fs_";
  protected final String TEXT_141 = ".open(file_";
  protected final String TEXT_142 = ");" + NL + "\t" + NL + "\t  int lineCount_";
  protected final String TEXT_143 = " = 0;" + NL + "\t  " + NL + "\t  ";
  protected final String TEXT_144 = NL + "\t  \tjava.io.BufferedReader br_";
  protected final String TEXT_145 = " = new java.io.BufferedReader(new java.io.InputStreamReader(fsdis_";
  protected final String TEXT_146 = ", ";
  protected final String TEXT_147 = "));" + NL + "\t  ";
  protected final String TEXT_148 = NL + "\t    org.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_149 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\tcodec_";
  protected final String TEXT_150 = ".setConf(conf_";
  protected final String TEXT_151 = ");\t" + NL + "\t  ";
  protected final String TEXT_152 = NL + "\t  \torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_153 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_154 = ");" + NL + "\t  ";
  protected final String TEXT_155 = NL + "\t  \torg.apache.hadoop.io.compress.CompressionInputStream in";
  protected final String TEXT_156 = " = codec_";
  protected final String TEXT_157 = ".createInputStream(fsdis_";
  protected final String TEXT_158 = ");" + NL + "\t  \tjava.io.BufferedReader br_";
  protected final String TEXT_159 = " = new java.io.BufferedReader(new java.io.InputStreamReader(in";
  protected final String TEXT_160 = ", ";
  protected final String TEXT_161 = "));" + NL + "\t  ";
  protected final String TEXT_162 = NL + "\t  " + NL + "\t  \t\t\t" + NL + "\t  String rowSeparator_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";" + NL + "\t  byte[] bytes_";
  protected final String TEXT_165 = " = rowSeparator_";
  protected final String TEXT_166 = ".getBytes();" + NL + "\t  int index_";
  protected final String TEXT_167 = " = 0, oneChar_";
  protected final String TEXT_168 = " = 0, tipEmptyLineCount_";
  protected final String TEXT_169 = " = 0; " + NL + "\t  boolean bTipEmptyFlagOpen_";
  protected final String TEXT_170 = " = true, bReadyEOF_";
  protected final String TEXT_171 = " = false;" + NL + "\t\t\t" + NL + "\t  if(bytes_";
  protected final String TEXT_172 = ".length > 0) {" + NL + "\t    while ((oneChar_";
  protected final String TEXT_173 = " = br_";
  protected final String TEXT_174 = ".read()) != -1) {" + NL + "\t      if (oneChar_";
  protected final String TEXT_175 = " == bytes_";
  protected final String TEXT_176 = "[index_";
  protected final String TEXT_177 = "]) {" + NL + "\t      " + NL + "\t        if (index_";
  protected final String TEXT_178 = " < bytes_";
  protected final String TEXT_179 = ".length - 1){" + NL + "\t          index_";
  protected final String TEXT_180 = " ++ ;" + NL + "\t          continue; // match next char" + NL + "\t        }" + NL + "\t        " + NL + "\t        if (index_";
  protected final String TEXT_181 = " == bytes_";
  protected final String TEXT_182 = ".length - 1) {                  " + NL + "\t          lineCount_";
  protected final String TEXT_183 = "++;" + NL + "\t          if(bTipEmptyFlagOpen_";
  protected final String TEXT_184 = ") {" + NL + "\t            tipEmptyLineCount_";
  protected final String TEXT_185 = " ++;" + NL + "\t            emptyLineCount_";
  protected final String TEXT_186 = " ++;" + NL + "\t          }" + NL + "\t          bReadyEOF_";
  protected final String TEXT_187 = " = false; // next row must be have char(or EOF flag)" + NL + "\t          bTipEmptyFlagOpen_";
  protected final String TEXT_188 = " = true; " + NL + "\t          index_";
  protected final String TEXT_189 = " = 0;" + NL + "\t        }" + NL + "\t        " + NL + "\t      }else{      " + NL + "\t        bReadyEOF_";
  protected final String TEXT_190 = " = true;" + NL + "\t        bTipEmptyFlagOpen_";
  protected final String TEXT_191 = " = false;" + NL + "\t        tipEmptyLineCount_";
  protected final String TEXT_192 = " = 0;" + NL + "\t        index_";
  protected final String TEXT_193 = " = 0;        " + NL + "\t      }" + NL + "\t    }" + NL + "\t    " + NL + "\t    if (bReadyEOF_";
  protected final String TEXT_194 = ") lineCount_";
  protected final String TEXT_195 = " ++ ; // add last row if not end by row separator" + NL + "\t    " + NL + "\t    if (bTipEmptyFlagOpen_";
  protected final String TEXT_196 = ") {" + NL + "\t      lineCount_";
  protected final String TEXT_197 = " -= tipEmptyLineCount_";
  protected final String TEXT_198 = ";" + NL + "\t      emptyLineCount_";
  protected final String TEXT_199 = " -= tipEmptyLineCount_";
  protected final String TEXT_200 = ";" + NL + "\t    }          " + NL + "\t  }" + NL + "\t  br_";
  protected final String TEXT_201 = ".close();" + NL + "\t";
  protected final String TEXT_202 = NL + "  \tlineCount_";
  protected final String TEXT_203 = " -= emptyLineCount_";
  protected final String TEXT_204 = ";" + NL + "\t";
  protected final String TEXT_205 = "   " + NL + "  \tglobalMap.put(\"";
  protected final String TEXT_206 = "_COUNT\",lineCount_";
  protected final String TEXT_207 = ");" + NL + "  \t" + NL + "\t";
  protected final String TEXT_208 = NL + "\tlog.info(\"";
  protected final String TEXT_209 = " - file : \" + file_";
  protected final String TEXT_210 = " + \" line count is \" + lineCount_";
