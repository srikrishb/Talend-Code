...
public class THDFSDeleteMainJava
{
  ...
  protected final String TEXT_136 = ");" + NL + "\tif(fs_";
  protected final String TEXT_137 = ".exists(path_";
  protected final String TEXT_138 = ")){" + NL + "\t\tif(fs_";
  protected final String TEXT_139 = ".delete(path_";
  protected final String TEXT_140 = ", true)){" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_141 = "_CURRENT_STATUS\", \"Path deleted.\");" + NL + "\t\t\t" + NL + "\t    \t";
  protected final String TEXT_142 = NL + "            log.info(\"";
  protected final String TEXT_143 = " - directory or file : \" + path_";
  protected final String TEXT_144 = " + \" is deleted.\");";
  protected final String TEXT_145 = NL + "\t\t}else{" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_146 = "_CURRENT_STATUS\", \"No path deleted.\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_147 = NL + "            log.info(\"";
  protected final String TEXT_148 = " - fail to delete directory or file : \" + path_";
  protected final String TEXT_149 = " + \".\");";
  protected final String TEXT_150 = NL + "\t\t}" + NL + "\t}else{" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_151 = "_CURRENT_STATUS\", \"Path does not exist.\");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_152 = NL + "       \tlog.warn(\"";
  protected final String TEXT_153 = " - directory or file : \" + path_";
  protected final String TEXT_154 = " + \" does not exist.\");";
  protected final String TEXT_155 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_156 = "_DELETE_PATH\",";
  protected final String TEXT_157 = ");" + NL + "\t" + NL + "" + NL + "" + NL + "" + NL + "\t";
