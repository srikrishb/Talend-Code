...
public class TMemSQLOutputEndJava
{
  ...
  protected final String TEXT_60 = NL + "                    if(batchSizeCounter_";
  protected final String TEXT_61 = " > 0){" + NL + "                        long countSum_";
  protected final String TEXT_62 = " = 0;" + NL + "                        int[] resultStatus = {};" + NL + "                        try {" + NL + "                            if (pstmt_";
  protected final String TEXT_63 = " != null) {";
  protected final String TEXT_64 = NL + "                               resultStatus = pstmt_";
  protected final String TEXT_65 = ".executeBatch();";
  protected final String TEXT_66 = NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_67 = "){";
  protected final String TEXT_68 = NL + "                                throw(e_";
  protected final String TEXT_69 = ");";
  protected final String TEXT_70 = NL + "                            System.out.println(e_";
  protected final String TEXT_71 = ".getMessage());" + NL + "                            for(int countEach_";
  protected final String TEXT_72 = ": e_";
  protected final String TEXT_73 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  protected final String TEXT_74 = " += (countEach_";
  protected final String TEXT_75 = " < 0 ? 0 : countEach_";
  protected final String TEXT_76 = ");" + NL + "                                }";
  protected final String TEXT_77 = NL + "                        }" + NL + "" + NL + "                        if (pstmt_";
  protected final String TEXT_78 = " != null) {" + NL + "                        " + NL + "                            long tmp_batchUpdateCount_";
  protected final String TEXT_79 = " = 0;" + NL + "                            for(int i : resultStatus){" + NL + "                                  if(i==-3){//EXECUTE_FAILED";
  protected final String TEXT_80 = NL + "                                        System.err.println(\"Query failed to execute.\");" + NL + "                                  }else if(i==-2){//SUCCESS_NO_INFO";
  protected final String TEXT_81 = NL + "                                        System.err.println(\"Query was processed successfully but that the number of rows affected is unknown.\");" + NL + "                                  }else{" + NL + "                                       tmp_batchUpdateCount_";
  protected final String TEXT_82 = " += (i<0 ? 0 : i);" + NL + "                                  }" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  ...
  protected final String TEXT_88 = NL + "                            += tmp_batchUpdateCount_";
  protected final String TEXT_89 = ";" + NL + "                        }" + NL + "                    }";
  protected final String TEXT_90 = NL + NL + "        if(pstmt_";
  ...
  protected final String TEXT_95 = " != null && !conn_";
  protected final String TEXT_96 = ".isClosed()) {";
