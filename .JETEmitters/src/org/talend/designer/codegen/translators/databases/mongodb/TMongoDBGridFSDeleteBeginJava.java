...
public class TMongoDBGridFSDeleteBeginJava
{
  ...
  protected final String TEXT_127 = ");" + NL + "            java.util.List<com.mongodb.gridfs.GridFSDBFile> gridfsFiles_";
  protected final String TEXT_128 = ";" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_130 = " = gridfs_";
  protected final String TEXT_131 = ".find(";
  protected final String TEXT_132 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tcom.mongodb.DBObject gridFSQuery_";
  protected final String TEXT_134 = " = (com.mongodb.DBObject) com.mongodb.util.JSON.parse(";
  protected final String TEXT_135 = ");" + NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_136 = " = gridfs_";
  protected final String TEXT_137 = ".find(gridFSQuery_";
  protected final String TEXT_138 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_139 = NL + "            for(com.mongodb.gridfs.GridFSDBFile gridFSfile : gridfsFiles_";
