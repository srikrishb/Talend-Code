...
public class TMongoDBGridFSGetBeginJava
{
  ...
  protected final String TEXT_125 = NL + "\t\t\tString outputLocalPath_";
  protected final String TEXT_126 = " = ";
  protected final String TEXT_127 = ";" + NL + "\t\t\tif(outputLocalPath_";
  protected final String TEXT_128 = " != null && !\"\".equals(outputLocalPath_";
  protected final String TEXT_129 = ")){" + NL + "\t\t\t\tjava.io.File outputLocalDir_";
  protected final String TEXT_130 = " = new java.io.File(outputLocalPath_";
  protected final String TEXT_131 = ");" + NL + "\t\t\t\toutputLocalDir_";
  protected final String TEXT_132 = ".mkdirs();" + NL + "\t\t\t} else {" + NL + "\t\t\t\tthrow new RuntimeException(\"The Output Folder cannot be left empty\");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + NL + "\t\t\tcom.mongodb.gridfs.GridFS gridfs_";
  protected final String TEXT_134 = " = new com.mongodb.gridfs.GridFS(db_";
  protected final String TEXT_135 = ", ";
  protected final String TEXT_136 = ");" + NL + "\t\t\tjava.util.List<com.mongodb.gridfs.GridFSDBFile> gridfsFiles_";
  protected final String TEXT_137 = ";" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_139 = " = gridfs_";
  protected final String TEXT_140 = ".find(";
  protected final String TEXT_141 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\tcom.mongodb.DBObject gridFSQuery_";
  protected final String TEXT_143 = " = (com.mongodb.DBObject) com.mongodb.util.JSON.parse(";
  protected final String TEXT_144 = ");" + NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_145 = " = gridfs_";
  protected final String TEXT_146 = ".find(gridFSQuery_";
  protected final String TEXT_147 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_148 = NL + NL + "\t\t\tfor(com.mongodb.gridfs.GridFSDBFile gridFSfile : gridfsFiles_";
