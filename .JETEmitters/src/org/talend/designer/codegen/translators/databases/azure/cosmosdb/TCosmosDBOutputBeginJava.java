...
public class TCosmosDBOutputBeginJava
{
  ...
  protected final String TEXT_48 = " = com.mongodb.MongoCredential.createPlainCredential(";
  protected final String TEXT_49 = ", \"$external\", new String(decryptedPassword_";
  protected final String TEXT_50 = ").toCharArray());";
  protected final String TEXT_51 = NL + "                            mongoCredential_";
  protected final String TEXT_52 = " = com.mongodb.MongoCredential.createScramSha1Credential(";
  protected final String TEXT_53 = ", ";
  protected final String TEXT_54 = ", new String(decryptedPassword_";
  protected final String TEXT_55 = ").toCharArray());";
  protected final String TEXT_56 = NL + "                        System.setProperty(\"java.security.krb5.realm\", ";
  protected final String TEXT_57 = ");" + NL + "                        System.setProperty(\"java.security.krb5.kdc\", ";
  protected final String TEXT_58 = ");" + NL + "                        System.setProperty(\"javax.security.auth.useSubjectCredsOnly\", \"false\");" + NL + "                        mongoCredential_";
  protected final String TEXT_59 = " = com.mongodb.MongoCredential.createGSSAPICredential(";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = NL + "                    mongoCredentialList_";
  protected final String TEXT_62 = ".add(mongoCredential_";
  protected final String TEXT_63 = ");";
  protected final String TEXT_64 = NL + "                    List<com.mongodb.ServerAddress> addrs_";
  protected final String TEXT_65 = " = new java.util.ArrayList<com.mongodb.ServerAddress>();";
  protected final String TEXT_66 = NL + "                        addrs_";
  protected final String TEXT_67 = ".add(new com.mongodb.ServerAddress(";
  protected final String TEXT_68 = ",";
  protected final String TEXT_69 = "));";
  protected final String TEXT_70 = NL + "                    mongo_";
  protected final String TEXT_71 = " = new ";
  protected final String TEXT_72 = "(addrs_";
  protected final String TEXT_73 = ", mongoCredentialList_";
  protected final String TEXT_74 = ", clientOptions_";
  protected final String TEXT_75 = ");";
  protected final String TEXT_76 = NL + "                    com.mongodb.ServerAddress serverAddress_";
  protected final String TEXT_77 = " = new com.mongodb.ServerAddress(";
  protected final String TEXT_78 = ", ";
  protected final String TEXT_79 = ");" + NL + "                    mongo_";
  protected final String TEXT_80 = " = new ";
  protected final String TEXT_81 = "(serverAddress_";
  protected final String TEXT_82 = ", mongoCredentialList_";
  protected final String TEXT_83 = ", clientOptions_";
  protected final String TEXT_84 = ");";
  protected final String TEXT_85 = NL + "\t\t\t\tresourceMap.put(\"mongo_";
  protected final String TEXT_86 = "\", mongo_";
  protected final String TEXT_87 = ");" + NL + "\t\t\t\tdb_";
  protected final String TEXT_88 = " = mongo_";
  protected final String TEXT_89 = ".getDB(";
  protected final String TEXT_90 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\tmongo_";
  protected final String TEXT_92 = ".setWriteConcern(com.mongodb.WriteConcern.";
  protected final String TEXT_93 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t        mongo_";
  protected final String TEXT_95 = ".addOption(com.mongodb.Bytes.QUERYOPTION_NOTIMEOUT);" + NL + "\t\t        ";
  protected final String TEXT_96 = NL + "\t\t\t";
  protected final String TEXT_97 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_98 = " - Connecting to \" + mongo_";
  protected final String TEXT_99 = ".getServerAddressList() + \".\");" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\tif(db_";
  protected final String TEXT_101 = ".collectionExists(";
  protected final String TEXT_102 = ")){" + NL + "\t\t\t\t\tdb_";
  protected final String TEXT_103 = ".getCollection(";
  protected final String TEXT_104 = ").drop();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\tcom.mongodb.DBCollection coll_";
  protected final String TEXT_106 = " = db_";
  protected final String TEXT_107 = ".getCollection(";
  protected final String TEXT_108 = ");" + NL + "\t\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\tcom.mongodb.BulkWriteOperation bulkWriteOperation_";
  protected final String TEXT_110 = " = coll_";
  protected final String TEXT_111 = ".initialize";
  protected final String TEXT_112 = "BulkOperation();" + NL + "\t\t\t\tint bulkWriteOperationCounter_";
  protected final String TEXT_113 = " = 1;" + NL + "\t\t\t\tint bulkWriteOperationSize_";
  protected final String TEXT_114 = " = Integer.parseInt(";
  protected final String TEXT_115 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_117 = " - Start to write data into database [\" + db_";
