...
public class TSAPHanaOutputEndJava
{
  ...
  protected final String TEXT_62 = NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_63 = ": pstmt_";
  protected final String TEXT_64 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_65 = " += (countEach_";
  protected final String TEXT_66 = " < 0 ? 0 : countEach_";
  protected final String TEXT_67 = ");" + NL + "\t\t\t\t}  " + NL + "\t\t\t\t";
  protected final String TEXT_68 = "               \t" + NL + "\t\t\t}" + NL + "\t    \t";
  protected final String TEXT_69 = NL + "\t    \t\tinsertedCount_";
  ...
  protected final String TEXT_75 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_76 = " += countSum_";
  protected final String TEXT_77 = ";" + NL + "\t    \t";
  protected final String TEXT_78 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_79 = "){" + NL + "    \t";
  protected final String TEXT_80 = NL + "    \t\tthrow(e_";
  protected final String TEXT_81 = ");" + NL + "    \t";
  protected final String TEXT_82 = NL + "    \tint countSum_";
  protected final String TEXT_83 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_84 = ": e_";
  protected final String TEXT_85 = ".getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  ...
  protected final String TEXT_98 = " " + NL + "    \tSystem.err.println(e_";
  protected final String TEXT_99 = ".getMessage());" + NL + "    \t";
  protected final String TEXT_100 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_101 = "   " + NL + "                " + NL + "        if(pstmt_";
  protected final String TEXT_102 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_103 = ".close();" + NL + "            " + NL + "        }        ";
