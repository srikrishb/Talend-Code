...
public class TCosmosDBWriteConfBeginJava
{
  ...
  protected final String TEXT_75 = NL + "\t\t\t\tresourceMap.put(\"mongo_";
  protected final String TEXT_76 = "\", mongo_";
  protected final String TEXT_77 = ");" + NL + "\t\t\t\tdb_";
  protected final String TEXT_78 = " = mongo_";
  protected final String TEXT_79 = ".getDB(";
  protected final String TEXT_80 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t        mongo_";
  protected final String TEXT_82 = ".addOption(com.mongodb.Bytes.QUERYOPTION_NOTIMEOUT);" + NL + "\t\t        ";
  protected final String TEXT_83 = NL + "\t\t\t\tmongo_";
  protected final String TEXT_84 = ".setWriteConcern(com.mongodb.WriteConcern.";
  protected final String TEXT_85 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_86 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_87 = " - Connecting to \" + mongo_";
  protected final String TEXT_88 = ".getServerAddressList() + \".\");" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\tif(db_";
  protected final String TEXT_90 = ".collectionExists(";
  protected final String TEXT_91 = ")){" + NL + "\t\t\t\t\tdb_";
  protected final String TEXT_92 = ".getCollection(";
  protected final String TEXT_93 = ").drop();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\tcom.mongodb.DBCollection coll_";
  protected final String TEXT_95 = " = db_";
  protected final String TEXT_96 = ".getCollection(";
  protected final String TEXT_97 = ");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\tcom.mongodb.BulkWriteOperation bulkWriteOperation_";
  protected final String TEXT_99 = " = coll_";
  protected final String TEXT_100 = ".initialize";
  protected final String TEXT_101 = "BulkOperation();" + NL + "\t\t\t\tint bulkWriteOperationCounter_";
  protected final String TEXT_102 = " = 1;" + NL + "\t\t\t\tint bulkWriteOperationSize_";
  protected final String TEXT_103 = " = Integer.parseInt(";
  protected final String TEXT_104 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\t" + NL + "\t\t\tnet.sf.json.xml.XMLSerializer xmlSerializer_";
  protected final String TEXT_106 = " = new net.sf.json.xml.XMLSerializer(); " + NL + "\t\t    xmlSerializer_";
  protected final String TEXT_107 = ".clearNamespaces();" + NL + "\t\t    xmlSerializer_";
  protected final String TEXT_108 = ".setSkipNamespaces(true);" + NL + "\t\t    xmlSerializer_";
  protected final String TEXT_109 = ".setForceTopLevelObject(";
  protected final String TEXT_110 = ");" + NL + "\t\t    ";
  protected final String TEXT_111 = NL + "\t\t\t\tjava.util.Queue<String> queue_";
  protected final String TEXT_112 = " = new java.util.concurrent.ConcurrentLinkedQueue<String>();" + NL + "\t\t\t\t" + NL + "\t\t\t\tclass ThreadXMLField_";
  protected final String TEXT_113 = " extends Thread {" + NL + "\t\t\t\t\tjava.util.Queue<String> queue;" + NL + "\t\t\t\t\tjava.util.List<java.util.Map<String,String>> flows;" + NL + "\t\t\t\t\tjava.lang.Exception lastException;" + NL + "\t\t\t\t\tString currentComponent;" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tThreadXMLField_";
  protected final String TEXT_114 = "(java.util.Queue q) {" + NL + "\t\t\t\t\t\tthis.queue = q;" + NL + "\t\t\t\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_115 = "\", queue);" + NL + "\t\t\t\t\t\tlastException = null;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tThreadXMLField_";
  protected final String TEXT_116 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "\t\t\t\t\t\tthis.queue = q;" + NL + "\t\t\t\t\t\tthis.flows = l;" + NL + "\t\t\t\t\t\tlastException = null;" + NL + "\t\t\t\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_117 = "\", queue);" + NL + "\t\t\t\t\t\tglobalMap.put(\"flows_";
  protected final String TEXT_118 = "\", flows);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tpublic java.lang.Exception getLastException() {" + NL + "\t\t\t\t\t\treturn this.lastException;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tpublic String getCurrentComponent() {" + NL + "\t\t\t\t\t\treturn this.currentComponent;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\t\t@Override" + NL + "\t\t\t\t\tpublic void run() {" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_119 = "Process(globalMap);" + NL + "\t\t\t\t\t\t} catch (TalendException te) {" + NL + "\t\t\t\t\t\t\tthis.lastException = te.getException();" + NL + "\t\t\t\t\t\t\tthis.currentComponent = te.getCurrentComponent();" + NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_120 = "_FINISH\" + (this.queue==null?\"\":this.queue.hashCode()), \"true\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\tThreadXMLField_";
  protected final String TEXT_121 = " txf_";
  protected final String TEXT_122 = " = new ThreadXMLField_";
  protected final String TEXT_123 = "(queue_";
  protected final String TEXT_124 = ");" + NL + "\t\t\t\ttxf_";
  protected final String TEXT_125 = ".start();" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tjava.util.Queue<String> queue_";
  protected final String TEXT_127 = " = (java.util.Queue<String>) globalMap.get(\"queue_";
  protected final String TEXT_128 = "\");" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\tString readFinishMarkWithPipeId_";
  protected final String TEXT_130 = " = \"";
  protected final String TEXT_131 = "_FINISH\"+(queue_";
  protected final String TEXT_132 = "==null?\"\":queue_";
  protected final String TEXT_133 = ".hashCode());" + NL + "\t\t\tString str_";
  protected final String TEXT_134 = " = null;" + NL + "\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_136 = " - Start to write data into database [\"+db_";
  protected final String TEXT_137 = ".getName()+\"], data is generated by [";
  protected final String TEXT_138 = "].\");" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t         /**" + NL + "             * Convert Date and Byte array in mongo DB format" + NL + "             *" + NL + "             */" + NL + "            class MongoDBTreeConverter_";
  protected final String TEXT_140 = " {" + NL + "" + NL + "                /**" + NL + "                 * header method to ease javajet implementation." + NL + "                 **/" + NL + "                public void processTree(Object currentElement, String[] path, String pattern) {" + NL + "                    if (currentElement instanceof com.mongodb.BasicDBObject) {" + NL + "                        // Start index at 1, in order to remove the first unwanted or empty string." + NL + "                        processTree((com.mongodb.BasicDBObject)currentElement, path, 1, pattern);" + NL + "                   } else if (currentElement instanceof com.mongodb.BasicDBList) {" + NL + "                       // Start index at 1, in order to remove the first unwanted or empty string." + NL + "                       processTree((com.mongodb.BasicDBList) currentElement, path, 1, pattern);" + NL + "                   }" + NL + "                }" + NL + "" + NL + "                public void processTree(com.mongodb.BasicDBObject currentElement, String[] path, int index, String pattern) {" + NL + "                    if (index  < path.length - 1) {" + NL + "                        Object nextElement = currentElement.get(path[index]);" + NL + "                        if (nextElement instanceof com.mongodb.BasicDBObject) {" + NL + "                             processTree((com.mongodb.BasicDBObject)nextElement, path, index + 1, pattern);" + NL + "                        } else if (nextElement instanceof com.mongodb.BasicDBList) {" + NL + "                            processTree((com.mongodb.BasicDBList) nextElement, path, index + 1, pattern);" + NL + "                        } else if (nextElement == null && index > 0) {" + NL + "                            // some loop are not reported by the XML tree" + NL + "                            nextElement = currentElement.get(path[index - 1]);" + NL + "                            if (nextElement != null) {" + NL + "                                if (nextElement instanceof com.mongodb.BasicDBObject) {" + NL + "                                    processTree((com.mongodb.BasicDBObject)nextElement, path, index, pattern);" + NL + "                               } else if (nextElement instanceof com.mongodb.BasicDBList) {" + NL + "                                   processTree((com.mongodb.BasicDBList) nextElement, path, index, pattern);" + NL + "                               }" + NL + "                            }" + NL + "                        }" + NL + "                    } else {" + NL + "                        // process leaf" + NL + "                        if (currentElement.get(path[path.length - 1]) instanceof com.mongodb.BasicDBList) {" + NL + "                            // if the leaf is a list" + NL + "                            com.mongodb.BasicDBList finalObjects = (com.mongodb.BasicDBList) currentElement.get(path[path.length - 1]);" + NL + "                            com.mongodb.BasicDBList convertedElements = new com.mongodb.BasicDBList();" + NL + "                            for (Object finalObject: finalObjects) {" + NL + "                                if (pattern == null) {" + NL + "                                    // no pattern, we want to parse to a byte array." + NL + "                                    if (finalObject != null) {" + NL + "\t\t\t\t\t\t\t\t                                convertedElements.add(" + NL + "\t\t\t\t\t\t\t\t                                        ((String)finalObject).getBytes());" + NL + "                                    }" + NL + "                                } else {" + NL + "                                    if (finalObject != null) {" + NL + "                                        convertedElements.add(" + NL + "                                                ParserUtils.parseTo_Date((String)finalObject," + NL + "                                                        pattern));" + NL + "                                    }" + NL + "                                }" + NL + "                            }" + NL + "                            finalObjects.clear();" + NL + "                            finalObjects.addAll(convertedElements);" + NL + "                        } else {" + NL + "                            if (pattern == null) {" + NL + "                                // no pattern, we want to parse to a byte array." + NL + "                                if (currentElement.get(path[path.length - 1]) != null) {" + NL + "\t\t\t\t\t\t\t\t                            currentElement.put(path[path.length - 1]," + NL + "\t\t\t\t\t\t\t\t                                    ((String)currentElement.get(path[path.length - 1])).getBytes());" + NL + "                                }" + NL + "                            } else {" + NL + "                                if (currentElement.get(path[path.length - 1]) != null) {" + NL + "                                    currentElement.put(path[path.length - 1]," + NL + "                                            ParserUtils.parseTo_Date((String)(currentElement).get(path[path.length - 1])," + NL + "                                                    pattern));" + NL + "                                }" + NL + "                            }" + NL + "                        }" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                public void processTree(com.mongodb.BasicDBList currentElements, String[] path, int index, String pattern) {" + NL + "                    if (index  < path.length - 1) {" + NL + "                        for (Object currentElement: currentElements) {" + NL + "                            if (currentElement instanceof com.mongodb.BasicDBObject) {" + NL + "                                processTree((com.mongodb.BasicDBObject)currentElement, path, index + 1, pattern);" + NL + "                            } else if (currentElement instanceof com.mongodb.BasicDBList) {" + NL + "                                processTree((com.mongodb.BasicDBList) currentElement, path, index + 1, pattern);" + NL + "                            }" + NL + "                        }" + NL + "                    } else {" + NL + "                        // process leaf" + NL + "                        com.mongodb.BasicDBList convertedElements = new com.mongodb.BasicDBList();" + NL + "                        for (Object finalObject: currentElements) {" + NL + "                            if (finalObject instanceof com.mongodb.BasicDBObject) {" + NL + "                                com.mongodb.BasicDBObject currentElement = (com.mongodb.BasicDBObject) finalObject;" + NL + "                                if (pattern == null) {" + NL + "                                    // no pattern, we want to parse to a byte array." + NL + "                                    if (currentElement.get(path[path.length - 1]) != null) {" + NL + "\t\t\t\t\t\t\t\t                                currentElement.put(path[path.length - 1]," + NL + "\t\t\t\t\t\t\t\t                                        ((String)currentElement.get(path[path.length - 1])).getBytes());" + NL + "                                    }" + NL + "                                } else {" + NL + "                                    if (currentElement.get(path[path.length - 1]) != null) {" + NL + "                                        currentElement.put(path[path.length - 1]," + NL + "                                                ParserUtils.parseTo_Date((String)(currentElement).get(path[path.length - 1])," + NL + "                                                        pattern));" + NL + "                                    }" + NL + "                                }" + NL + "                            } else { // loop with raw types" + NL + "                                if (pattern == null) {" + NL + "                                    // no pattern, we want to parse to a byte array." + NL + "                                    if (finalObject != null) {" + NL + "\t\t\t\t\t\t\t\t                                convertedElements.add(" + NL + "\t\t\t\t\t\t\t\t                                        ((String)finalObject).getBytes());" + NL + "                                    }" + NL + "                                } else {" + NL + "                                    if (finalObject != null) {" + NL + "                                        convertedElements.add(" + NL + "                                                ParserUtils.parseTo_Date((String)finalObject," + NL + "                                                        pattern));" + NL + "                                    }" + NL + "                                }" + NL + "                            }" + NL + "                        }" + NL + "                        if (convertedElements.size() > 0) {" + NL + "                            currentElements.clear();" + NL + "                            currentElements.addAll(convertedElements);" + NL + "                        }" + NL + "                    }" + NL + "" + NL + "                }" + NL + "            }" + NL + "            MongoDBTreeConverter_";
  protected final String TEXT_141 = " mongoDBTreeConverter_";
  protected final String TEXT_142 = " = new MongoDBTreeConverter_";
  protected final String TEXT_143 = "();" + NL + "\t\t\twhile(!globalMap.containsKey(readFinishMarkWithPipeId_";
  protected final String TEXT_144 = ") || !queue_";
  protected final String TEXT_145 = ".isEmpty()) {" + NL + "\t\t\t\tif (!queue_";
  protected final String TEXT_146 = ".isEmpty()) {" + NL + "\t\t\t\t\tstr_";
  protected final String TEXT_147 = " = queue_";
  protected final String TEXT_148 = ".poll();" + NL + "\t\t\t\t\t//Convert XML to JSON" + NL + "\t\t\t        net.sf.json.JSON json_";
  protected final String TEXT_149 = " = xmlSerializer_";
  protected final String TEXT_150 = ".read(str_";
