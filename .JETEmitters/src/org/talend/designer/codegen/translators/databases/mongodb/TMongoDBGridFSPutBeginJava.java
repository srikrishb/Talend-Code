...
public class TMongoDBGridFSPutBeginJava
{
  ...
  protected final String TEXT_128 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t" + NL + "\t\t\tclass FileInfo_";
  protected final String TEXT_129 = " {" + NL + "\t\t\t\tString newName;" + NL + "\t\t\t\tboolean setMetadata;" + NL + "\t\t\t\tString metadataJson;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<java.util.Map<String,FileInfo_";
  protected final String TEXT_130 = ">> list_";
  protected final String TEXT_131 = " = new java.util.ArrayList<java.util.Map<String,FileInfo_";
  protected final String TEXT_132 = ">>();" + NL + "\t\t\t" + NL + "\t\t\tFileInfo_";
  protected final String TEXT_133 = " fileInfo_";
  protected final String TEXT_134 = " = null;\t" + NL + "\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\tjava.util.Map<String,FileInfo_";
  protected final String TEXT_136 = "> map_";
  protected final String TEXT_137 = "_";
  protected final String TEXT_138 = " = new java.util.HashMap<String,FileInfo_";
  protected final String TEXT_139 = ">();" + NL + "\t\t\t\t" + NL + "\t\t\t\tfileInfo_";
  protected final String TEXT_140 = " = new FileInfo_";
  protected final String TEXT_141 = "();" + NL + "\t\t\t\t" + NL + "\t\t\t\tfileInfo_";
  protected final String TEXT_142 = ".newName = ";
  protected final String TEXT_143 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\tfileInfo_";
  protected final String TEXT_145 = ".setMetadata = ";
  protected final String TEXT_146 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\tfileInfo_";
  protected final String TEXT_148 = ".metadataJson = ";
  protected final String TEXT_149 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t" + NL + "\t\t\t\tmap_";
  protected final String TEXT_151 = "_";
  protected final String TEXT_152 = ".put(";
  protected final String TEXT_153 = ", fileInfo_";
  protected final String TEXT_154 = ");" + NL + "\t\t\t \tlist_";
  protected final String TEXT_155 = ".add(map_";
  protected final String TEXT_156 = "_";
  protected final String TEXT_157 = ");       " + NL + "\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\tString localdir_";
  protected final String TEXT_159 = "  = ";
  protected final String TEXT_160 = ";\t" + NL + "\t\t\tfor (java.util.Map<String, FileInfo_";
  protected final String TEXT_161 = "> map_";
  protected final String TEXT_162 = " : list_";
