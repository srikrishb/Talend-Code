...
public class THiveCreateTableMainJava
{
  ...
  protected final String TEXT_684 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_685 = " = conn_";
  protected final String TEXT_686 = ".createStatement();";
  protected final String TEXT_687 = NL + "    String query_";
  protected final String TEXT_688 = " = \"\";" + NL + "    String tableName_";
  protected final String TEXT_689 = " = ";
  protected final String TEXT_690 = ";";
  protected final String TEXT_691 = NL + "    String likeTableName_";
  protected final String TEXT_692 = " = ";
  protected final String TEXT_693 = ";";
  protected final String TEXT_694 = NL + "        String location_";
  ...
  protected final String TEXT_709 = ".close();" + NL + "            globalMap.put(\"";
  protected final String TEXT_710 = "_QUERY\", querySQL_";
  protected final String TEXT_711 = ");" + NL + "        " + NL + "            String currentClientPathSeparator_";
  protected final String TEXT_712 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "            if(currentClientPathSeparator_";
  protected final String TEXT_713 = "!=null) {" + NL + "                System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_714 = ");" + NL + "                globalMap.put(\"current_client_path_separator\", null);" + NL + "            }";
  protected final String TEXT_715 = NL + "                conn_";
  protected final String TEXT_716 = ".close();";
  protected final String TEXT_717 = NL + "                bw_";
  protected final String TEXT_718 = ".write(querySQL_";
  protected final String TEXT_719 = " + \";\");" + NL + "                globalMap.put(\"";
  protected final String TEXT_720 = "_QUERY\", querySQL_";
  protected final String TEXT_721 = ");" + NL + "    " + NL + "                bw_";
  protected final String TEXT_722 = ".close();" + NL + "    " + NL + "                if(libjars_";
  protected final String TEXT_723 = ".length() > 0) {" + NL + "                    instance_";
  protected final String TEXT_724 = ".setLibJars(libjars_";
  protected final String TEXT_725 = ".toString().substring(0, libjars_";
  protected final String TEXT_726 = ".length()-1));" + NL + "                }" + NL + "                instance_";
  protected final String TEXT_727 = ".callWS(instance_";
  protected final String TEXT_728 = ".sendFiles());" + NL + "                int exitCode_";
  protected final String TEXT_729 = " = instance_";
  protected final String TEXT_730 = ".execute();" + NL + "                if(exitCode_";
  protected final String TEXT_731 = " > 0) {" + NL;
  protected final String TEXT_732 = NL + "                        throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_733 = NL + "                        System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_734 = NL + "                            log.error(\"";
  protected final String TEXT_735 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_736 = NL + "                }";
  protected final String TEXT_737 = NL + "                    log.debug(\"Query for ";
  protected final String TEXT_738 = ": \" + querySQL_";
  protected final String TEXT_739 = ".replace(\"';'\", \"'\\\\;'\") + \";\");";
  protected final String TEXT_740 = NL + "                instance_";
  protected final String TEXT_741 = ".addQuery(querySQL_";
  protected final String TEXT_742 = ".replace(\"';'\", \"'\\\\;'\") + \";\");" + NL + "                if(libjars_";
  protected final String TEXT_743 = ".length() > 0) {" + NL + "                    instance_";
  protected final String TEXT_744 = ".addLibJars(libjars_";
  protected final String TEXT_745 = ".toString().substring(0, libjars_";
  protected final String TEXT_746 = ".length()-1));" + NL + "                }" + NL + "                int exitCode_";
  protected final String TEXT_747 = " = instance_";
  protected final String TEXT_748 = ".executeJob();" + NL + "                System.out.println(instance_";
  protected final String TEXT_749 = ".getJobLog());" + NL + "                if(exitCode_";
  protected final String TEXT_750 = " > 0) {" + NL;
  protected final String TEXT_751 = NL + "                        throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_752 = NL + "                        System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_753 = NL + "                            log.error(\"";
  protected final String TEXT_754 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_755 = NL + "                }";
  protected final String TEXT_756 = NL + "\t\t\t\t\tString comment_";
  protected final String TEXT_757 = "_";
  protected final String TEXT_758 = "_";
  protected final String TEXT_759 = " = ";
  protected final String TEXT_760 = ";";
  protected final String TEXT_761 = NL + "\t\t\t\t\tString comment_";
  protected final String TEXT_762 = "_";
  protected final String TEXT_763 = "_";
  protected final String TEXT_764 = " = ";
  protected final String TEXT_765 = ";";
  protected final String TEXT_766 = NL + "\t\t\t\t\tString key_";
  protected final String TEXT_767 = "_";
  protected final String TEXT_768 = "_";
  protected final String TEXT_769 = " = ";
  protected final String TEXT_770 = ";" + NL + "\t\t\t\t\tString value_";
  protected final String TEXT_771 = "_";
  protected final String TEXT_772 = "_";
  protected final String TEXT_773 = " = ";
  protected final String TEXT_774 = ";";
  protected final String TEXT_775 = NL + "    String tableComment_";
  protected final String TEXT_776 = " = ";
  protected final String TEXT_777 = ";";
  protected final String TEXT_778 = NL + "    String clustededOrSkewed_";
  protected final String TEXT_779 = " = ";
  protected final String TEXT_780 = ";";
  protected final String TEXT_781 = NL + "            String fieldChar_";
  protected final String TEXT_782 = " = ";
  protected final String TEXT_783 = ";";
  protected final String TEXT_784 = NL + "                String escapeChar_";
  protected final String TEXT_785 = " = ";
  protected final String TEXT_786 = ";";
  protected final String TEXT_787 = NL + "            String collectionChar_";
  protected final String TEXT_788 = " = ";
  protected final String TEXT_789 = ";";
  protected final String TEXT_790 = NL + "            String mapChar_";
  protected final String TEXT_791 = " = ";
  protected final String TEXT_792 = ";";
  protected final String TEXT_793 = NL + "            String lineChar_";
  protected final String TEXT_794 = " = ";
  protected final String TEXT_795 = ";";
  protected final String TEXT_796 = NL + "        String serdeName_";
  protected final String TEXT_797 = " = ";
  protected final String TEXT_798 = ";";
  protected final String TEXT_799 = NL + "        String inputClass_";
  protected final String TEXT_800 = " = ";
  protected final String TEXT_801 = ";" + NL + "        String outputClass_";
  protected final String TEXT_802 = " = ";
  protected final String TEXT_803 = ";";
  protected final String TEXT_804 = NL + "    String storageClass_";
  protected final String TEXT_805 = " = ";
  protected final String TEXT_806 = ";";
  protected final String TEXT_807 = NL + "            String decryptedS3Password_";
  protected final String TEXT_808 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_809 = ");";
  protected final String TEXT_810 = NL + "            String decryptedS3Password_";
  protected final String TEXT_811 = " = ";
  protected final String TEXT_812 = ";";
  protected final String TEXT_813 = NL + "        String location_";
  protected final String TEXT_814 = " = \"s3n://\" + ";
  protected final String TEXT_815 = " +\":\" + decryptedS3Password_";
  protected final String TEXT_816 = " + \"@\" + ";
  protected final String TEXT_817 = ";";
  protected final String TEXT_818 = NL + "    String location_";
  protected final String TEXT_819 = " = ";
  protected final String TEXT_820 = ";";
  protected final String TEXT_821 = NL + "    String select_";
  protected final String TEXT_822 = " = ";
  protected final String TEXT_823 = ";";
  protected final String TEXT_824 = NL + "String querySQL_";
  protected final String TEXT_825 = " = \"";
  protected final String TEXT_826 = "\";";
  protected final String TEXT_827 = NL + "try {" + NL + "    stmt_";
  protected final String TEXT_828 = ".execute(querySQL_";
  protected final String TEXT_829 = ");" + NL + "} catch(java.sql.SQLException e_";
  protected final String TEXT_830 = ") {";
  protected final String TEXT_831 = NL + "        throw(e_";
  protected final String TEXT_832 = ");";
  protected final String TEXT_833 = NL + "        System.err.println(e_";
  protected final String TEXT_834 = ".getMessage());";
  protected final String TEXT_835 = NL + "        }" + NL + "stmt_";
  protected final String TEXT_836 = ".close();";
  protected final String TEXT_837 = NL + "    conn_";
  protected final String TEXT_838 = ".close();";
  protected final String TEXT_839 = NL + "globalMap.put(\"";
  protected final String TEXT_840 = "_QUERY\", querySQL_";
  protected final String TEXT_841 = ");" + NL + "" + NL + "String currentClientPathSeparator_";
  protected final String TEXT_842 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_843 = "!=null) {" + NL + "    System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_844 = ");" + NL + "    globalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String currentClientUsername_";
  protected final String TEXT_845 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "if(currentClientUsername_";
  protected final String TEXT_846 = "!=null) {" + NL + "    System.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_847 = ");" + NL + "    globalMap.put(\"current_client_user_name\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_848 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_849 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_850 = "!=null) {" + NL + "    System.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_851 = ");" + NL + "    globalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_852 = "\", null);" + NL + "} else {" + NL + "    System.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
  protected final String TEXT_853 = NL + "            bw_";
  protected final String TEXT_854 = ".write(querySQL_";
  protected final String TEXT_855 = " + \";\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_856 = "_QUERY\", querySQL_";
  protected final String TEXT_857 = ");" + NL + "    " + NL + "            bw_";
  protected final String TEXT_858 = ".close();" + NL + "    " + NL + "            if(libjars_";
  protected final String TEXT_859 = ".length() > 0) {" + NL + "                instance_";
  protected final String TEXT_860 = ".setLibJars(libjars_";
  protected final String TEXT_861 = ".toString().substring(0, libjars_";
  protected final String TEXT_862 = ".length()-1));" + NL + "            }" + NL + "            instance_";
  protected final String TEXT_863 = ".callWS(instance_";
  protected final String TEXT_864 = ".sendFiles());" + NL + "            int exitCode_";
  protected final String TEXT_865 = " = instance_";
  protected final String TEXT_866 = ".execute();" + NL + "            if(exitCode_";
  protected final String TEXT_867 = " > 0) {" + NL + "    ";
  protected final String TEXT_868 = NL + "                    throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_869 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_870 = NL + "                        log.error(\"";
  protected final String TEXT_871 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_872 = NL + "            }";
  protected final String TEXT_873 = NL + "                log.debug(\"Query for ";
  protected final String TEXT_874 = ": \" + querySQL_";
  protected final String TEXT_875 = ".replace(\"';'\", \"'\\\\;'\") + \";\");";
  protected final String TEXT_876 = NL + "            instance_";
  protected final String TEXT_877 = ".addQuery(querySQL_";
  protected final String TEXT_878 = ".replace(\"';'\", \"'\\\\;'\") + \";\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_879 = "_QUERY\", querySQL_";
  protected final String TEXT_880 = ");" + NL + "            int exitCode_";
  protected final String TEXT_881 = " = instance_";
  protected final String TEXT_882 = ".executeJob();" + NL + "            System.out.println(instance_";
  protected final String TEXT_883 = ".getJobLog());" + NL + "            if(exitCode_";
  protected final String TEXT_884 = " > 0) {" + NL + "    ";
  protected final String TEXT_885 = NL + "                    throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_886 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_887 = NL + "                        log.error(\"";
  protected final String TEXT_888 = " - The Hive job failed. Please read the logs for more details\");";
